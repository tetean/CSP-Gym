...
from environments.Ar import CSPEnergyReward
import numpy as np
...
def compute_lattice_params(lx, ly, lz, xy, xz, yz):
    ...
    alpha = np.arccos(yz / c) * 180 / np.pi
...
def find_reference_structure_with_lammps():
    ...
    commands = [
        ...
        "pair_coeff 1 1 0.0104 3.405",  # ε, σ
...
def evaluate_pretrained_model(algorithm, rec_path, num_atoms, reward_class, s_true, E_true, num_eval_episodes=1000,
    ...
    env = gym.make('CSPEnv-LAMMPS-v1', num_atoms=num_atoms, reward_class=reward_class)
    ...
    for i in range(num_eval_episodes):
        ...
        SS = compute_rmsd(s_pred, ['Ar', 'Ar', 'Ar', 'Ar'], s_true, ['Ar', 'Ar', 'Ar', 'Ar'])
    ...
    return {'Algorithm': algorithm, 'EE': avg_EE, 'SS': avg_SS, 'CR': CR, 'CR_energy': CR_energy, 'CC': CC}


def evaluate_all_algorithms(model_paths, num_atoms, reward_class, s_true, E_true, num_eval_episodes=1000, epsilon=3.5,
                            epsilon_E=0.001, output_dir='evaluation_results'):
    ...
    for algo in algorithms:
        if algo in model_paths:
            print(f"\nEvaluating {algo}...")
            result = evaluate_pretrained_model(algo, model_paths[algo], num_atoms, reward_class, s_true, E_true,
    ...
    csv_path = os.path.join(output_dir, f'evaluation_summary_{current_time}.csv')
...
if __name__ == "__main__":
    ...
    model_paths = {
        'PPO': '/home/wangxiean/PycharmProjects/CSP-gym/results/PPO/20250327_082234/',
        'SAC': '/home/wangxiean/PycharmProjects/CSP-gym/results/SAC/20250327_012630',
        'TD3': '/home/wangxiean/PycharmProjects/CSP-gym/results/TD3/20250327_050216',
        'A2C': '/home/wangxiean/PycharmProjects/CSP-gym/results/A2C/20250327_062904',
        'DDPG': '/home/wangxiean/PycharmProjects/CSP-gym/results/DDPG/20250327_071053'
    }
